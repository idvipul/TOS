...
void init_idt_entry(int intr_no, void (*isr) (void))
{
    ...
    idt[intr_no].selector = CODE_SELECTOR; // 8 : this is the segment selector for the code segment in TOS
...
void init_interrupts()
{
    ...
    interrupts_initialized = TRUE; // C variable to check for interrupts.
    asm("sti");
}
